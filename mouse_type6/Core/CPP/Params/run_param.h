...
const static t_pid_gain search_om_gain = {0.4, 0.01, 0.0};
...
const static t_turn_param_table slalom_outL135_500_table = {0.50f, 40.0f,7.75,21.71, 135.0f,Turn_L};
const static t_turn_param_table slalom_outR135_500_table = {0.50f,-40.0f,7.75,21.71,-135.0f,Turn_R};
...
const static t_param *const mode_500[] = 	{	&param_dummy,		&param_dummy,		&param_dummy,
												...
												&param_LongRV90_500,	&param_LongLV90_500
											};
