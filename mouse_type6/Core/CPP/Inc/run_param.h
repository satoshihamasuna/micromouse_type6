...
const static t_turn_param_table slalom_L90_500_table = {0.50f, 42.5f,31.50+10.0,33.87+5.0, 90.0f,Turn_L};
const static t_turn_param_table slalom_R90_500_table = {0.50f,-42.5f,31.50+10.0,33.87+5.0,-90.0f,Turn_R};
