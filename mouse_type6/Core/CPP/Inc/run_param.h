...
const static t_turn_param_table slalom_L90_table = {0.30f, 25.0f,14.72-4.0,11.93+0.0, 90.0f,Turn_L};
const static t_turn_param_table slalom_R90_table = {0.30f,-25.0f,14.72-4.0,11.93+0.0,-90.0f,Turn_R};
